...
<details>
<summary><strong>🍰 ティラミス</strong> - イタリアンデザートの代表格</summary>

![ティラミス](./public/ティラミス.png)

**特徴**: マスカルポーネチーズとコーヒーの風味が特徴的な層状のデザート。濃厚でなめらかな食感が楽しめます。

**価格**: ¥520 | **カテゴリ**: デザート
</details>

<details>
<summary><strong>🥑 アボカドトースト</strong> - 栄養満点のヘルシーメニュー</summary>

![アボカドトースト](./public/アボカドトースト.png)

**特徴**: 新鮮なアボカドとポーチドエッグの栄養満点トースト。ヘルシー志向の方に人気の軽食メニューです。

**価格**: ¥890 | **カテゴリ**: 軽食
</details>

<details>
<summary><strong>🦐 ガーリックシュリンプ</strong> - 香り豊かな海鮮料理</summary>

![ガーリックシュリンプ](./public/ガーリックシュリンプ.png)

**特徴**: プリプリのエビをガーリックバターで炒めた香り豊かな一品。ビールやワインとの相性も抜群です。
...
1. アプリケーションにアクセス
2. カメラアイコンをクリック
3. 上記画像のいずれかを撮影またはアップロード
4. AI解析結果と料理詳細情報が表示されることを確認

> **注意**: 最適な認識精度を得るために、料理全体が画面に収まるよう撮影してください。
